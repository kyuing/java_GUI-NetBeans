...
public class GridLayoutEx  extends JFrame {
    ...
    public static void main(String[] args) {
       ...
       this.setTitle("JTextFiled, JButton JLabel and GridLayout");
       
       /* how GridLayout works is that
           it does its best effort within a given condition.
           for example,
          you have GridLayout ex = new GridLayout(2,2);
          you then have btn1 btn2 and btn3 to put into the grid
          btn1 is assinged at (0,0)
          btn2 is assinged at (0,1)
          btn3 is assinged at (1,0)
          null (or empty) is is assinged at (1,1)
       */
       GridLayout gridL = new GridLayout(2,2);  //create an instance of GridLayout with a specified constructor having x y axis parameterers
